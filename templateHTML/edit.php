...
<body>
    ...
    <div class="list-container">
        ...
        <div class="button-group">
            <button onclick="window.location.href='add.php'" class="add-question-btn">Ajouter une question</button>
            <button onclick="window.location.href='index.php'" class="logout-btn">Déconnexion</button>
        </div>
